...
urlpatterns = [
                  ...
                  url(r'^$', views.lists, name='list'),#The homepage URL to be followed
                  url(r'^login/$', auth_views.login,{'template_name': 'login.html'}, name='login'),
                  url(r'^signup/$', views.signup, name='signup'),
                  url(r'^logout/$', views.log_out, name='logout'),
#All the URL which we go from the List page
...
url(r'^lists/delcom/(\d+)/', views.deletecomment, name='delcomment'),
url(r'^lists/editcom/(\d+)/', views.editcomment, name='editcomment'),
